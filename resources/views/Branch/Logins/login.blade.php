...
<head>
    <meta charset="utf-8" />
    <title>Branch Login | ChromoXpert</title>
    ...
    <div class="login-container">
        <div class="login-form">
            <div class="login-header">
                ...
                <h1 class="login-title">Branch Login</h1>
            </div>
            <form action="{{ route('branch.login.post') }}" method="post" id="loginForm">
                @csrf
                ...
                <button class="btn-login" type="submit">Login to Branch</button>
            </form>
        </div>
    </div>
