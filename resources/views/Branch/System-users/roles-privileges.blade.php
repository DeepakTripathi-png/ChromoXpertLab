...
@section('meta_title', 'Roles & Privileges | ChromoXpert')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="p-4 rounded-4 mb-4 position-relative overflow-hidden shadow-lg"
                ...
                <h2 class="fw-bold mb-1">Roles & Privileges</h2>
                <p class="mb-0">Manage system roles and their permissions</p>
                <a href="{{ url('branch/roles-privileges/add') }}" 
                        ...
                        <table id="cims_data_table" class="table align-middle table-hover">
                            <thead style="background: linear-gradient(135deg, #ac7fb6 0%, #f6b51d 100%); color: #fff;">
                                <tr>
                                    ...
                                    <th style="width:45%">Privileges</th>
...
@section('script')
<script src="{{ URL::asset('branch/controller_js/cn_roles_previllages.js')}}"></script>
@endsection