        ...
        <div class="container-fluid">
            ...
            <div class="card border-0 shadow-lg rounded-4" 
                ...
                <div class="card-body p-4">
                    <form action="{{ route('branch.system-user.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-3" id="name" name="name" 
                                                   placeholder=" " value="{{ !empty($system_user) ? $system_user->name : old('name') }}" required
                                                   style="background: #fff; color: #6267ae; border: 1px solid #f6b51d;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-3" id="mobile_no" name="mobile_no" 
                                                   placeholder=" " value="{{ !empty($system_user) ? $system_user->mobile : old('mobile_no') }}" required
                                                   style="background: #fff; color: #6267ae; border: 1px solid #f6b51d;">
...
<script>
    ...
    $(".add-system-user").addClass("menuitem-active");
</script>
...
<script>
    $(document).ready(function() {
        ...
        $("#email").on("keyup", function() {
            $.ajax({
                type: "get",
                url: "{{ url('/branch/system-user/check-user-exist') }}",
                data: {
                    email: $(this).val(),
                    user_id: $("#id").val()
                },
