        ...
        <div class="container-fluid">
            ...
            <div class="card border-0 shadow-lg rounded-4"
                ...
                <div class="card-body p-4">
                    <form action="{{ route('branch.roles-privileges.store') }}" method="post">
                        @csrf
                                    ...
                                    <table class="table table-hover table-bordered" id="role-privileges-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="fade-in-row">
                                                ...
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_add" class="ccheckbox add" value="reports_add" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'reports_add') ? 'checked' : '' }}></td>
                                                ...
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_delete" class="ccheckbox deletes" value="reports_delete" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'reports_delete') ? 'checked' : '' }}></td>
                                                <td class="text-center"><input type="checkbox" name="privileges[]" id="reports_status_change" class="ccheckbox status" value="reports_status_change" {{ isset($role_privileges) && !empty($role_privileges->privileges) && str_contains($role_privileges->privileges, 'reports_status_change') ? 'checked' : '' }}></td>
                                                <td class="text-center"></td>
                                            </tr>
                                            <tr class="fade-in-row">
...
<script>
    $(document).ready(function(){
        $("#role_name").on("keyup", function(){
            $.ajax({
                type: "get",
                url: "{{ url('/branch/roles-privileges/check-role-exist') }}",
                data: {
                    role_name: $(this).val(),
                    role_id: $("#id").val()
                },
