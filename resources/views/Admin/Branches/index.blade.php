...
@section('meta_title') Branches/Collection Centers/Hospital | ChromoXpert @endsection
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="p-4 rounded-4 mb-4 position-relative overflow-hidden shadow-lg"
                ...
                <h2 class="fw-bold mb-1">Branches/Collection Centers/Hospital</h2>
                <p class="mb-0">Manage all branches/collection centers/hospital details and statuses</p>
                <a href="{{ url('admin/branches/add') }}" 
                   ...
                   style="background: #f6b51d; color: #1f2937; border: none;">
                    <i class="mdi mdi-plus me-2"></i> Add Branch/Collection Center/Hospital
                </a>
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                <input type="text" id="searchInput" class="form-control rounded-pill shadow-sm" 
                       placeholder="Search branches/collection centers/hospitals..." style="max-width: 250px; background: #fff; color: #6267ae; border: 1px solid #f6b51d;padding-top:9px; padding-bottom:9px;">
                        ...
                        <table id="cims_data_table" class="table align-middle table-hover">
                            <thead style="background: linear-gradient(135deg, #ac7fb6 0%, #f6b51d 100%); color: #fff;">
                                <tr>
                                    ...
                                    <th>Code</th>
                                    <th>Type</th>
                                    <th>Branch/Collection Center/Hospital Image</th>
                                    <th>Branch/Collection Center/Hospital Name</th>
                                    <th>Branch/Collection Center/Hospital Address</th>
                                    <th>Phone</th>
                                    <th>Email</th>
                                    <th>Status</th>
